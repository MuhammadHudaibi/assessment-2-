...
import org.d3if3010.assessment_2.databinding.FragmentHitungBinding
import org.d3if3010.assessment_2.db.Nilai
...
class HitungFragment : Fragment() {
    ...
    private fun getHurufLabel(kategori: Kategori): String {
        val stringRes = when (kategori){
            Kategori.A -> R.string.nilai_a
            Kategori.B -> R.string.nilai_b
            Kategori.C -> R.string.nilai_c
        }
